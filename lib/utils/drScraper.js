...
var drScraper = function (_scraper) {
    ...
    _createClass(drScraper, [{
        ...
        value: function parseDetailsUrl(body) {
            ...
            if (firstListCell) detailsUrl = "" + this.siteUrl + firstListCell.querySelector('.item-name').attributes.href;
            if (detailsUrl) return detailsUrl;else throw new Error('Unable to parse details url');
        }
    }, {
        key: "parseBook",
