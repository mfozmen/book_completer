...
var AttributesMapException = function (_Error) {
  _inherits(AttributesMapException, _Error);

  function AttributesMapException() {
    _classCallCheck(this, AttributesMapException);

    var _this = _possibleConstructorReturn(this, (AttributesMapException.__proto__ || Object.getPrototypeOf(AttributesMapException)).call(this, 'Attributes is not type Map'));
