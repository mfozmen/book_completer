...
var MethodCallEmptyException = function (_Error) {
  _inherits(MethodCallEmptyException, _Error);

  function MethodCallEmptyException() {
    _classCallCheck(this, MethodCallEmptyException);

    var _this = _possibleConstructorReturn(this, (MethodCallEmptyException.__proto__ || Object.getPrototypeOf(MethodCallEmptyException)).call(this, 'Method name cannot be empty'));
